...
<body>
    ...
    <div class="container">
        ...
        <?php else : ?>
                    ...
                    <tbody>
                        <?php foreach ($products as $productId => $productInfo) : ?>
                            <tr>
                                ...
                                <td class="total-price"><?php echo $productInfo['quantity'] * $productInfo['price']; ?></td>
                                <td>
            ...
            <p class="total-section">Tổng số lượng sản phẩm: <?php echo count($cartItems); ?></p>
            <p class="total-section">Tổng tiền: <span id="totalPrice"><?php echo $totalPrice; ?></span></p>
